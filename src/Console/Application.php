...
class Application extends BaseApplication {
	...
	public function getDefinition() {
		...
		$parent->addOption(new InputOption('neo-user', 'u', InputOption::VALUE_REQUIRED, 'Username for Neo4j server', ''));
		$parent->addOption(new InputOption('neo-password', 'p', InputOption::VALUE_REQUIRED, 'Password for Neo4j server', ''));
